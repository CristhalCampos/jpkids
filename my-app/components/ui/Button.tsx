...
export default function Button({
  ...
  const combinedClasses = `inline-flex items-center justify-center font-medium transition-all rounded-xl active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed ${
